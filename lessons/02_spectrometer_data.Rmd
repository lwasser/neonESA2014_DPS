...
#the coordinates for the extent are in lat long, let's convert them manually to UTM to make sure things line up. This information will generally be found in the metadata.
ex[1] <-256507.3
ex[2] <-257011.9
ex[3] <-4112083.6
ex[4] <-4112556.6
...
#maybe we want to use our raster in another program. here is how to write it out in tif format.
writeRaster(rgb_stack,file="/Users/lwasser/Documents/dropbox/ESA2014_Data/test/test4.tif",overwrite=TRUE)
```
