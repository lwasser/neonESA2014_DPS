...
This is great, but let's say you have some point data.  In our case we have two files.  One with plot centroids where stem heights were measured, and one with the full data. Let's start by plotting all our sampled points and their centroid (in red) on the map.
...
cent_ovr <- extract(canopy,centroid_sp,buffer = 40)
