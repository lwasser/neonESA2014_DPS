...
# things i want to be able to do still
# i want to be able to set hte color for th eplots - we should plot NDVI using greyscale OR a gradient of green to brown.
# can i set the colormap somehow using values for an image.
# where is the raster stack getting the resolution from? it should be 1 m resolution. 
